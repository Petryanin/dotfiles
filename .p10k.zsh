...
() {
  ...
  #################################[ dracula default separator symbols ]##################################
  ...
  # Untracked files icon. Default is question mark.
  ...
  function my_git_formatter() {
    ...
    # ✖42 if have merge conflicts. Default is ~.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}✖${VCS_STATUS_NUM_CONFLICTED}"
    # ●42 if have staged changes. Default is +.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}●${VCS_STATUS_NUM_STAGED}"
    # ✚42 if have unstaged changes. Default is !.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}✚${VCS_STATUS_NUM_UNSTAGED}"
    # …42 if have untracked files. Default is question mark.
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=60 # default 67
